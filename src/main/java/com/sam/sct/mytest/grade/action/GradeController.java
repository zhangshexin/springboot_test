...
public class GradeController {
    ...
    public Object saveOrUpdateGrade(@RequestParam("userId") int userId, @RequestParam("specialId") int specialId, @RequestParam("grade") int grade) {
        Grade grade1 = new Grade();
        grade1.setUserId(userId);
        grade1.setGrade(grade);
        grade1.setSpecialId(specialId);
