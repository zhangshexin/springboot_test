...
public interface GradeMapper {
     ...
     * @return
     */
    List<Grade> selectTop(@Param(value = "num") int num,@Param(value = "specialId") int specialId);
     ...
     * @return
     */
    GradeWithRank seleGradeByUserId(@Param("userId") int userId,@Param("specialId")int specialId);
}